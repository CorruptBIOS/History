...
!(function (t) {
  ...
  function (t, e, n) {
    ...
    H.prototype[B] || E(H.prototype, B, H.prototype.valueOf),
      M(H, 'Symbol'),
      (T[F] = !0);
  },
  function (t, e, n) {
  ...
  function (t, e, n) {
    ...
    n(117);
    var r = n(52);
    n(48), n(49), n(11), n(71), n(12), n(16), n(178);
    var o = n(77);
    function i(t) {
      return (
        (function (t) {
      ...
      return [
        ...
        function (t, r) {
          ...
          for (var _ = []; ; ) {
            ...
            if (null === w) break;
            if ((_.push(w), !b)) break;
            '' === String(w[0]) && (y.lastIndex = u(m, i(y.lastIndex), x));
          }
          for (var O, S = '', j = 0, A = 0; A < _.length; A++) {
            w = _[A];
            for (
              var E = String(w[0]),
                k = l(p(a(w.index), m.length), 0),
                C = [],
                $ = 1;
              $ < w.length;
              $++
            ...
            var T = w.groups;
            if (g) {
              var P = [E].concat(C, k, m);
              void 0 !== T && P.push(T);
              var L = String(r.apply(void 0, P));
            } else L = s(E, m, k, C, T, r);
      ...
      if (
        (C &&
          ...
          d !== Object.prototype &&
            ...
            (l ||
              i(x) === d ||
              (a ? a(x, d) : 'function' != typeof x[y] && u(x, y, m)),
            c(x, S, !0, !0),
            l && (p[S] = m))),
        'values' == h &&
          E &&
        ...
        if (
          ...
          for (w in _) (v || j || !(w in A)) && s(A, w, _[w]);
        else r({ target: e, proto: !0, forced: v || j }, _);
      return _;
    };
  },
  function (t, e, n) {
  ...
  function (t, e, n) {
    n(0)({ target: 'Object', stat: !0, sham: !n(10) }, { create: n(38) });
  },
  function (t, e) {
    t.exports = function (t, e) {
  ...
  function (t, e, n) {
    n(0)({ target: 'Object', stat: !0 }, { setPrototypeOf: n(122) });
  },
  function (t, e, n) {
    var r = n(0),
      o = n(35),
  ...
  function (t, e) {
    ...
    t.exports = function (t, e, n) {
      ...
      function b(t) {
        return (s = t), (c = setTimeout(_, e)), f ? g(t) : a;
      }
      function x(t) {
        var n = t - u;
      ...
      function O() {
        ...
        if (((r = arguments), (o = this), (u = t), n)) {
          ...
          if (y) return (c = setTimeout(_, e)), g(u);
        }
        ...
        polyfill: function () {
          ...
          function h(e) {
            ...
            (a = c = c > 1 ? 1 : c),
              ...
              (r === e.x && o === e.y) || t.requestAnimationFrame(h.bind(t, e));
          }
          function d(n, r, a) {
            var u,
              s,
            ...
            n === e.body
              ? ((u = t),
                ...
                (l = o.scroll))
              : ((u = n), (s = n.scrollLeft), (f = n.scrollTop), (l = c)),
              h({
                scrollable: u,
                method: l,
                startTime: p,
    ...
    t.exports = function (t) {
      ...
      if (
        ...
        for (n = new v((e = c(d.length))); e > x; x++)
          (h = g ? m(d[x], x) : d[x]), u(n, x, h);
      else
        for (p = (l = b.call(d)).next, n = new v(); !(f = p.call(l)).done; x++)
          (h = g ? i(l, m, [f.value, x], !0) : f.value), u(n, x, h);
      return (n.length = x), n;
    };
  },
  function (t, e, n) {
  ...
  function (t, e, n) {
    ...
    var r = n(0),
      ...
      i = n(27);
    r(
      { target: 'String', proto: !0, forced: !n(126)('includes') },
      {
        includes: function (t) {
      ...
      u ||
        ...
        'function' == typeof V &&
          c(
            ...
            {
              fetch: function (t) {
                return j(F, V.apply(s, arguments));
              },
            }
          ))),
  ...
  function (t, e, n) {
    ...
    n(163), n(67), n(12), n(16), n(79), n(33);
    var i = Object.freeze({});
    function a(t) {
      return null == t;
    }
      ...
      if (!a || !1 !== a.configurable) {
        ...
        Object.defineProperty(t, e, {
          ...
          get: function () {
            ...
            return (
              pt.target &&
                (i.depend(), s && (s.dep.depend(), Array.isArray(e) && Tt(e))),
              e
            );
          },
          set: function (e) {
            ...
            e === r ||
              (e != e && r != r) ||
              (c && !u) ||
              (u ? u.call(t, e) : (n = e), (s = !o && Et(e)), i.notify());
          },
        });
      }
    }
                    ...
                    f(d) &&
                      (v(d)
                        ...
                        : v(d.component) &&
                          ...
                          c(d.error) && (t.errorComp = He(d.error, e)),
                          c(d.loading) &&
          ...
          if (u(t.options.functional))
            return (function (t, e, n, r, o) {
              var a = t.options,
                u = {},
                s = a.props;
              if (c(s)) for (var f in s) u[f] = Bt(f, s, e || i);
          ...
          if ('string' == typeof e) {
            ...
            (s = (t.$vnode && t.$vnode.ns) || U.getTagNamespace(e)),
              (i = U.isReservedTag(e)
                ...
                : (n && n.pre) || !c((l = Ft(t.$options, 'components', e)))
    ...
    function Xe(t, e, n) {
      (ze = t), ue(e, n || {}, Ge, Ye, Ke, t), (ze = void 0);
    }
    var Je = null;
    function Qe(t) {
      var e = Je;
    ...
    function bn(t, e, n) {
      var r = !it();
      'function' == typeof n
        ? ((vn.get = r ? xn(e) : _n(n)), (vn.set = L))
        : ((vn.get = n.get ? (r && !1 !== n.cache ? xn(e) : _n(n.get)) : L),
          (vn.set = n.set || L)),
    ...
    function pr(t, e) {
      ...
      if (
        ...
        var r,
          ...
          u = t.data.attrs || {},
          s = e.data.attrs || {};
        for (r in (c(s.__ob__) && (s = e.data.attrs = T({}, s)), s))
          (o = s[r]), u[r] !== o && hr(i, r, o);
        for (r in ((J || Z) && s.value !== u.value && hr(i, 'value', s.value),
        u))
          a(s[r]) &&
            (Fn(r)
              ? i.removeAttributeNS(Dn, Bn(r))
    ...
    function Ar(t, e) {
      if (!a(t.data.domProps) || !a(e.data.domProps)) {
        var n,
          ...
          i = t.data.domProps || {},
          u = e.data.domProps || {};
        for (n in (c(u.__ob__) && (u = e.data.domProps = T({}, u)), i))
          n in u || (o[n] = '');
        for (n in u) {
          ...
          if ('value' === n && 'PROGRESS' !== o.tagName) {
            ...
            var s = a(r) ? '' : String(r);
            Er(o, s) && (o.value = s);
          } else if ('innerHTML' === n && Yn(o.tagName) && a(o.innerHTML)) {
            (Sr = Sr || document.createElement('div')).innerHTML =
              '<svg>' + r + '</svg>';
            for (var f = Sr.firstChild; o.firstChild; )
    ...
    qr &&
      ...
      void 0 === window.onanimationend &&
        ...
        ((Yr = 'WebkitAnimation'), (Kr = 'webkitAnimationEnd')));
    var Xr = G
    ...
    function Zr(t, e) {
      t._transitionClasses && x(t._transitionClasses, e), zr(t, e);
    }
    function to(t, e, n) {
      var r = no(t, e),
        o = r.type,
        ...
        if (!E || _ || '' === _) {
          ...
          var M = !1 !== o && !Q,
            ...
            F = (n._enterCb = D(function () {
              M && (Zr(n, $), Zr(n, C)),
                F.cancelled ? (M && Zr(n, k), R && R(n)) : L && L(n),
                (n._enterCb = null);
            }));
          t.data.show ||
            ...
            M &&
              ...
              Jr(function () {
                Zr(n, k),
                  F.cancelled ||
                    (Qr(n, $), N || (co(I) ? setTimeout(F, I) : to(n, i, F)));
              })),
        ...
        w.cancelled ||
          ...
          b &&
            ...
            Jr(function () {
              Zr(n, u),
                w.cancelled ||
                  (Qr(n, s), x || (co(_) ? setTimeout(w, _) : to(n, i, w)));
            })),
          h && h(n, w),
          b || x || w());
      }
    ...
    var Ao = function (t) {
      ...
      Co = T({ tag: String, moveClass: String }, wo);
    function $o(t) {
    ...
    (jn.config.mustUseProp = function (t, e, n) {
      ...
      T(jn.options.directives, _o),
      T(jn.options.components, Lo),
    ...
    var Zo = {
      ...
      render: function (t, e) {
        ...
        return (
          m && (Io(s[c], { route: u, configProps: m }), ti(y, i, u, m)),
          a(y, i, r)
        );
      },
    };
      ...
      Si = {
        ...
        render: function (t) {
          var e = this,
            ...
            v = a.redirectedFrom ? qo(null, _i(a.redirectedFrom), null, n) : a;
    ...
    function Ci(t, e) {
      ...
      function a(t, n, a) {
        ...
        if (s) {
          ...
          return (c.path = xi(f.path, c.params)), u(f, c, a);
        }
        if (c.path) {
          c.params = {};
      ...
      function c(t, n) {
        ...
        if (f) {
          ...
          return a(
            { _normalized: !0, path: xi(d, h), query: l, hash: p },
            void 0,
            n
          );
        }
    ...
    function $i(t, e, n) {
      ...
      for (var o = 1, i = r.length; o < i; ++o) {
        ...
        a &&
          (n[a.name || 'pathMatch'] =
            'string' == typeof r[o] ? Bo(r[o]) : r[o]);
      }
      return !0;
    }
    var Ti =
      Ai && window.performance && window.performance.now
        ? window.performance
        : Date;
    function Pi() {
    ...
    function Ni() {
      ...
      return (
        ...
        function () {
          window.removeEventListener('popstate', Bi);
        }
      );
    }
    function Di(t, e, n, r) {
    ...
    function ba(t) {
      Gi ? Yi(ma(t)) : (window.location.hash = t);
    }
    function xa(t) {
      Gi ? Ki(ma(t)) : window.location.replace(ma(t));
    }
    var _a = (function (t) {
        function e(e, n) {
    ...
    (wa.prototype.match = function (t, e, n) {
      ...
      (wa.version = '3.5.1'),
      (wa.isNavigationFailure = ra),
      (wa.NavigationFailureType = Ji),
      (wa.START_LOCATION = Go),
      Ai && window.Vue && window.Vue.use(wa);
    var ja = wa;
    n(268), n(173), n(269), n(116), n(271), n(127), n(128), n(272);
    function Aa(t) {
      t.locales &&
    ...
    var Ea = n(51),
      ka =
        ...
        {
          NotFound: function () {
            return n.e(7).then(n.bind(null, 447));
          },
          Layout: function () {
            return Promise.all([n.e(0), n.e(3), n.e(4)]).then(
              n.bind(null, 446)
            );
          },
        }),
      Ca = {
        'v-7129cff6': function () {
          return n.e(8).then(n.bind(null, 449));
        },
      };
    function $a(t) {
      var e = Object.create(null);
      ...
      Xa = {
        created: function () {
          if (
            ((this.siteMeta = this.$site.headTags
              .filter(function (t) {
                return 'meta' === Object(Ga.a)(t, 1)[0];
              })
              .map(function (t) {
                var e = Object(Ga.a)(t, 2);
                e[0];
                return e[1];
              })),
            this.$ssrContext)
            ...
            (this.$ssrContext.title = this.$title),
              ...
              (this.$ssrContext.pageMeta = (e = t)
                ? e
                    ...
                    .join('\n    ')
                : ''),
              (this.$ssrContext.canonicalLink = Qa(this.$canonicalUrl));
          }
          var e;
        },
        mounted: function () {
        ...
        methods: {
          updateMeta: function () {
            ...
            var t = this.getMergedMetaTags();
            this.currentMetaTags = Za(t, this.currentMetaTags);
          },
        ...
        beforeDestroy: function () {
          Za(null, this.currentMetaTags), Ja();
        },
      };
    function Ja() {
    ...
    var ec = n(206),
      ...
      ic = {
        mounted: function () {
          var t = this;
          oc.a.configure({ showSpinner: !1 }),
            this.$router.beforeEach(function (t, e, n) {
              t.path === e.path || Ro.component(t.name) || oc.a.start(), n();
            }),
            this.$router.afterEach(function () {
              oc.a.done(), (t.isSidebarOpen = !1);
            });
        },
      },
      ac = n(207),
      ...
      sc = {
        ...
        computed: {
          layout: function () {
            ...
            return Wa('layout', t), Ro.component(t);
          },
        },
        methods: {
          getLayout: function () {
    ...
    var pc = [
      ...
      hc = {
        ...
        pages: [
          {
            title: 'Home',
            frontmatter: { home: !0, heroImage: '/PB-Logo.png' },
            regularPath: '/',
        ...
        themeConfig: {
          ...
          nav: [
            ...
            },
            {
              ...
              items: [
                { text: 'PB', link: 'https://discord.gg/RHWxvhc' },
                { text: 'PBST', link: 'https://discord.gg/DDUzTwM' },
                { text: 'TMS', link: 'https://discord.gg/3axZ5tb' },
                { text: 'PET', link: 'https://discord.gg/t4KBPkM' },
                { text: 'PBA', link: 'https://discord.gg/MVAcxTS' },
                { text: 'PBM', link: 'https://discord.gg/yTVFKne' },
                { text: 'MM', link: 'https://discord.gg/EjBYFCd' },
                { text: 'PBQA', link: 'https://discord.gg/6xwcuRh' },
              ],
            },
            {
              text: 'Group Links',
    ...
    n(373);
    Ro.component('Counter', function () {
      return n.e(6).then(n.bind(null, 448));
    }),
      Ro.component('Badge', function () {
        return Promise.all([n.e(0), n.e(5)]).then(n.bind(null, 450));
      });
    n(374), n(375);
    n(376);
    var dc = [
            ...
            if (t.hash) {
              ...
              return (
                ...
                window.scrollTo({
                  ...
                  { x: u.left - c.left, y: u.top - c.top }).y,
                  behavior: 'smooth',
                })
              );
            }
    ...
    function gc(t, e, n) {
      return e && mc(t.prototype, e), n && mc(t, n), t;
    }
    n(209);
    n(201);
    function bc(t, e) {
    ...
    var _c = n(208),
      wc = n.n(_c);
    function Oc(t, e) {
      return !e || ('object' !== wc()(e) && 'function' != typeof e)
        ? (function (t) {
            if (void 0 === t)
    ...
    var jc = (function (t) {
      ...
      var e = Sc(n);
      function n() {
        return yc(this, n), e.apply(this, arguments);
      }
      return n;
    })(
      (function () {
        function t() {
          yc(this, t), (this.store = new Ro({ data: { state: {} } }));
        }
        return (
          gc(t, [
            {
    ...
    (Ro.config.productionTip = !1),
      ...
      Ro.component('Content', Cc),
      Ro.component('ContentSlotsDistributor', $c),
      Ro.component('OutboundLink', Pc),
      ...
      (window.__VUEPRESS__ = { version: '1.8.2', hash: '1dc782a' }),
      (function (t) {
