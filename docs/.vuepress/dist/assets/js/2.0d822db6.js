  ...
  [2],
  {
      ...
      r('match', function (t, e, n) {
        return [
          ...
          function (t) {
            ...
            var l = i.unicode;
            i.lastIndex = 0;
            for (var f, p = [], d = 0; null !== (f = h(i, r)); ) {
              var g = o(f[0]);
              (p[d] = g),
                '' === g && (i.lastIndex = c(r, s(i.lastIndex), l)),
                d++;
            }
            return 0 === d ? null : p;
          },
        ...
        function (t, e, n) {
          ...
          return (
                ...
                ? function (t, n) {
                    ...
                    for (
                      ...
                      !(
                        (c = b.lastIndex) > v &&
                        ($(f, L(a, v, u.index)),
                        u.length > 1 && u.index < a.length && i(y, f, g(u, 1)),
                        (h = u[0].length),
                        (v = c),
                        f.length >= s)
                      );
            ...
            [
              function (e, n) {
                var i = l(this),
                  s = null == e ? void 0 : d(e, t);
                return s ? r(s, e, i, n) : r(a, p(i), e, n);
              },
              function (t, i) {
                var r = u(this),
                  s = p(t),
                ...
                var l = c(r, RegExp),
                  ...
                  g =
                    ...
                    (r.unicode ? 'u' : '') +
                    (_ ? 'g' : 'y'),
                  m = new l(_ ? '^(?:' + r.source + ')' : r, g),
                  b = void 0 === i ? 4294967295 : i >>> 0;
                if (0 === b) return [];
                if (0 === s.length) return null === v(m, s) ? [s] : [];
                for (var k = 0, y = 0, C = []; y < s.length; ) {
                  m.lastIndex = _ ? 0 : y;
                  var w,
                    O = v(m, _ ? L(s, y) : s);
                  if (
                    null === O ||
                    (w = x(f(m.lastIndex + (_ ? y : 0)), s.length)) === k
                  )
                    y = h(s, y, d);
                  else {
                    if (($(C, L(s, k, y)), C.length === b)) return C;
                    for (var S = 1; S <= O.length - 1; S++)
                      if (($(C, O[S]), C.length === b)) return C;
                    y = k = w;
                  }
                }
                return $(C, L(s, k)), C;
    ...
    339: function (t, e, n) {
      var i = n(2),
        ...
        h = function (t) {
          return function (e) {
            var n = a(r(e));
            return 1 & t && (n = o(n, l, '')), 2 & t && (n = o(n, c, '')), n;
          };
        };
    ...
    340: function (t, e, n) {
      ...
      var i = n(1),
        r = n(339).trim;
      i(
        { target: 'String', proto: !0, forced: n(369)('trim') },
        {
          trim: function () {
            return r(this);
          },
      ...
      var i = n(9),
        ...
        W =
          ...
          (!D ||
            ...
            C ||
            m(function () {
              return (A[$] = !1), L(N) != N || L(A) == A || '/a/i' != L(N, 'i');
            }));
      if (s('RegExp', W)) {
        for (
          var G = function (t, e) {
              ...
              if (
                ((d || h(w, t)) &&
                  ((t = t.source), g && (e = ('flags' in m) ? m.flags : S(m))),
                (t = void 0 === t ? '' : p(t)),
                (e = void 0 === e ? '' : p(e)),
                (m = t),
                y &&
        ...
        a(
          ...
          function () {
            ...
            return (
              ...
              e +
              '/' +
              u(void 0 === n && o(h, t) && !('flags' in h) ? p(t) : n)
            );
          },
          { unsafe: !0 }
        );
    ...
    361: function (t, e, n) {
      ...
      var i = n(334),
        r = {
          name: 'SidebarGroup',
          components: { DropdownTransition: n(362).a },
          props: ['item', 'open', 'collapsable', 'depth'],
          beforeCreate: function () {
            this.$options.components.SidebarLinks = n(361).default;
          },
    ...
    363: function (t, e, n) {
      ...
      var i = n(1),
        r = n(364);
      i(
        { target: 'String', proto: !0, forced: n(365)('link') },
        {
          link: function (t) {
      ...
      r(
        {
          ...
          forced:
            !!(
              f ||
              v ||
              ((i = s(String.prototype, 'endsWith')), !i || i.writable)
            ) && !v,
        },
        {
          endsWith: function (t) {
            ...
            var n = arguments.length > 1 ? arguments[1] : void 0,
              ...
              a = u(t);
            return p ? p(e, a, r) : d(e, r - a.length, r) === a;
          },
        }
      );
    },
    ...
    389: function (t, e, n) {
      ...
      var $ = {
          ...
          mounted: function () {
            var t = this,
              e =
                parseInt(C(this.$el, 'paddingLeft')) +
                parseInt(C(this.$el, 'paddingRight')),
              n = function () {
      ...
      var A = R,
        ...
        H = {
          name: 'Sidebar',
          components: { SidebarLinks: n(361).default, NavLinks: y },
          props: ['items'],
        },
        W =
          (n(385),
